  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div
          className="mt-12 grid overflow-hidden rounded-[28px] border border-slate-200 bg-white/80 px-5 py-6 shadow-[0_14px_40px_rgba(26,58,108,0.05)] backdrop-blur-xl sm:grid-cols-2 lg:grid-cols-4"
          data-reveal
        >
          {stats.map(({ icon: Icon, value, label }, index) => (
            ...
            >
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-slate-100 text-xl text-[#1a3a6c]">
                <Icon />
              </span>
              <div>
